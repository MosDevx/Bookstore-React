...
> An application to allow a user to add,edit,delete and view a list of Books.
...
- **[Display Book Completion Progress]**
...
```sh
  cd my-folder
  git clone git@github.com:mosdevx/React-Bookstore.git
```
